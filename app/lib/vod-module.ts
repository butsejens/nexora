...
export function enrichVodModuleItem(baseItem: any, detail?: any): VodModuleItem {
  ...
  return {
    ...
    poster: detail?.poster ?? detail?.posterUri ?? baseItem.poster ?? baseItem.posterUri ?? null,
    backdrop: detail?.backdrop ?? detail?.backdropUri ?? baseItem.backdrop ?? baseItem.backdropUri ?? null,
