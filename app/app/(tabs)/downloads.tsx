  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.info}>
        ...
        <Text style={styles.dateText}>{t("downloads.downloadedOn", { date: formatDate(item.downloadedAt) })}</Text>
        <View style={styles.actions}>
          <TouchableOpacity style={styles.playBtn} onPress={onPlay} activeOpacity={0.8}>
            ...
            <Text style={styles.playBtnText}>{t("downloads.play")}</Text>
          </TouchableOpacity>
      ...
      {downloads.length > 0 && (
        <SurfaceCard style={styles.summary}>
          ...
          <Text style={styles.summaryText}>
            {t("downloads.itemsSaved", { n: downloads.length })}
      ...
      {downloads.length === 0 ? (
        <View style={styles.empty}>
          <StateBlock
            ...
            message={t("downloads.noDownloadsSub")}
          />
          <View style={styles.emptyActions}>
            ...
            >
              ...
              <Text style={styles.emptyBtnText}>{t("downloads.goToMovies")}</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.emptyBtn}
            ...
            >
              ...
              <Text style={styles.emptyBtnText}>{t("downloads.goToSeries")}</Text>
            </TouchableOpacity>
          </View>
        </View>
      ) : (
