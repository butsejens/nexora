    ...
    return (
      <View style={styles.screen}>
        <View style={styles.card}>
          ...
          <Text style={styles.title}>Premium is actief</Text>
          <Text style={styles.body}>
            Alle premiumfuncties van Nexora zijn momenteel ontgrendeld op dit toestel.
          </Text>
          <TouchableOpacity style={styles.button} onPress={() => router.back()} activeOpacity={0.86}>
            <Text style={styles.buttonText}>Terug naar Nexora</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
