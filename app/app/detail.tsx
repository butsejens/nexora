...
const styles = StyleSheet.create({
  ...
  hero: { height: isTV ? 480 : 380, position: "relative" },
  ...
  heroContentTitle: { fontFamily: "Inter_800ExtraBold", fontSize: isTV ? 38 : 28, color: COLORS.text, lineHeight: isTV ? 44 : 32, marginBottom: 4 },
  ...
  heroMetaText: { fontFamily: "Inter_500Medium", fontSize: isTV ? 16 : 13, color: COLORS.textSecondary },
  ...
  infoSection: { paddingHorizontal: isTV ? 32 : 16, paddingTop: isTV ? 20 : 12 },
  ...
  genrePillText: { fontFamily: "Inter_500Medium", fontSize: isTV ? 14 : 11, color: COLORS.textSecondary },
  actionButtons: { flexDirection: "row", gap: 10, marginBottom: 20, alignItems: "center" },
  playBtn: { flex: 1, borderRadius: 12, overflow: "hidden" },
  playBtnInner: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: isTV ? 18 : 14, backgroundColor: COLORS.accent, borderRadius: 12 },
  ...
  playBtnText: { fontFamily: "Inter_700Bold", fontSize: isTV ? 20 : 16, color: "#FFFFFF" },
  ...
  tabText: { fontFamily: "Inter_500Medium", fontSize: isTV ? 18 : 14, color: COLORS.textMuted },
  tabTextActive: { color: COLORS.accent, fontFamily: "Inter_600SemiBold" },
  tabContent: { paddingBottom: 8 },
  synopsis: { fontFamily: "Inter_400Regular", fontSize: isTV ? 18 : 15, color: COLORS.textSecondary, lineHeight: isTV ? 28 : 24, marginBottom: 16 },
  ...
  seasonName: { fontFamily: "Inter_600SemiBold", fontSize: isTV ? 18 : 15, color: COLORS.text },
